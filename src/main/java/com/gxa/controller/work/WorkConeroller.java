...
public class WorkConeroller {
    ...
    @ResponseBody
    public R patientList(@ApiParam("搜索的名字")String name,@ApiParam("搜索开始时间") Date strTime, @ApiParam("搜索结束时间")Date endTime, @ApiParam("近几天？")Integer days,@ApiParam("今天的日期") Date today){
        Date date = new Date();
