...
public class InboundManagerVisualData {
    ...
    {
        //初始化新增药品
        InboundInfoAddArray.add(new InboundInfoAddArray(1,"asdsad1","阿莫西林1","白云制药厂代理部1",632,"/盒",32.0,65.0,"132qwead","2050-05-02",1700.0,1600.0));
        InboundInfoAddArray.add(new InboundInfoAddArray(2,"asdsad2","阿莫西林2","白云制药厂代理部2",6321,"/盒",32.0,65.0,"132qwead","2050-05-02",1700.0,1600.0));
        InboundInfoAddArray.add(new InboundInfoAddArray(3,"asdsad3","阿莫西林3","白云制药厂代理部3",6322,"/盒",32.0,65.0,"132qwead","2050-05-02",1700.0,1600.0));
        InboundInfoAddArray.add(new InboundInfoAddArray(4,"asdsad4","阿莫西林4","白云制药厂代理部4",6332,"/盒",32.0,65.0,"132qwead","2050-05-02",1700.0,1600.0));
        //第一条list
        inboundInfos.add(new InboundInfo(1,"asdadsadsa","采购入库","白云制药厂","lx",2100.0,2400.0,"lx","2016-5-8",0,"2019-2-3","白云代理部","2019-9-9","666",null));
